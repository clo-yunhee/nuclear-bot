 ...
 */
public class DialogChangePlugin extends JDialog implements ActionListener, PropertyChangeListener, DocumentListener {
	...
	public DialogChangePlugin(final ControlPanel controlPanel, final PluginLoader pluginLoader)
	{
		super(controlPanel.getFrame(), "", true);
	...
	private void chooseFile()
	{
		...
		if (filename != null)
		{
			m_lastFile = new File(filename);
			m_textFieldFile.setText(filename);
		}
	}
