...
/**
 * Public API interface for a chat listener.<br></br>
 * <br></br>
...
interface ClientListener {
     ...
     */
    fun onConnected(client: ChatClient)
     ...
     * @param client the Twitch client
     */
    fun onDisconnected(client: ChatClient)
     ...
     */
    fun onCommandRegistered(client: ChatClient, label: String, command: Command)
     ...
     * @param label  the command label
     */
    fun onCommandUnregistered(client: ChatClient, label: String)
